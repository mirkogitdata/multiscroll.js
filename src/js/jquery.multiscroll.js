...
(function ($, window, document, Math, undefined) {
    $.fn.multiscroll = function (options) {
      ...
      function silentScroll() {
        ...
        if (options.css3) {
          transformContainer(
            $(".ms-left"),
            "translate3d(0px, -" +
              $(".ms-left").find(".ms-section.active").position().top +
              "px, 0px)",
            false
          );
          transformContainer(
      ...
      function scrollPage(leftDestination) {
        ...
        var rightDestination = $(".ms-right")
          .find(".ms-section")
          .eq(numberSections - 1 - leftDestinationIndex);
        ...
        if (options.css3) {
          ...
          $.isFunction(options.onLeave) &&
            options.onLeave.call(
              this,
              leavingSection,
              leftDestinationIndex + 1,
              yMovement
            );
  
          var translate3dLeft =
            "translate3d(0px, -" + topPos["left"] + "px, 0px)";
          var translate3dRight =
            "translate3d(0px, -" + topPos["right"] + "px, 0px)";
          ...
          setTimeout(function () {
            ...
            $.isFunction(options.afterLoad) &&
              options.afterLoad.call(this, anchorLink, leftDestinationIndex + 1);
      ...
      function scrollToAnchor() {
        ...
        var section = $(
          '.ms-left .ms-section[data-anchor="' + sectionAnchor + '"]'
        );
